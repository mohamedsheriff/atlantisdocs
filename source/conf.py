...
# Added by satish to support localization 
...
latex_documents = [
    (master_doc, 'AtlantisDocs.tex', u'Atlantis Docs Documentation',
     u'Quantela Inc', 'manual'),
]
...
intersphinx_mapping = {'rtd': ('https://atlantisdocs.readthedocs.io/en/latest/', None)}
